...
//
//     // ---- BOOKINGS (with optional date range filter) ----
//     final allBookings = boxBooking.getAll().where((b) {
//       final ci = DateTime.tryParse(b.checkInDate);
//       if (ci == null) return false;
//
//       if (start != null && ci.isBefore(DateTime(start.year, start.month, start.day))) {
//         return false;
//       }
//       if (end != null && ci.isAfter(
...
//
//       // daily
//       if (!checkIn.isBefore(todayStart)) {
//         daily += bill;
//         dailyCount++;
//       }
//
//       // weekly (from Monday)
//       if (!checkIn.isBefore(weekStart)) {
//         weekly += bill;
//         weeklyCount++;
//       }
//
...
//       monthMap[monthKey] = (monthMap[monthKey] ?? 0) + bill;
//
//       // weekly graph (Mon..Sun)
//       final diff = now.difference(checkIn).inDays;
//       if (diff >= 0 && diff < 7) {
//         final index = checkIn.weekday - 1; // 1..7 -> 0..6
//         if (index >= 0 && index < 7) {
//           weeklyArray[index] += bill;
//         }
//       }
//     }
//
...
//     weekOutflow.value = List<double>.filled(7, 0.0); // TODO: hook with expense data later
//
//     // Room status
